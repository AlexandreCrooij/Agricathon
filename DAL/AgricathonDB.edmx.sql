...
-- --------------------------------------------------
-- Date Created: 05/18/2018 13:32:11
-- Generated from EDMX file: C:\Users\alexa\source\repos\Agricathon\DAL\AgricathonDB.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [AgricathonDB_Surprise];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_AspNetUserOrder]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Orders] DROP CONSTRAINT [FK_AspNetUserOrder];
GO
IF OBJECT_ID(N'[dbo].[FK_AspNetUserProduct]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Products] DROP CONSTRAINT [FK_AspNetUserProduct];
GO
...
CREATE TABLE [dbo].[AspNetUsers] (
    ...
    [isAllergicNuts] bit  NOT NULL,
    [isAllergicMilk] bit  NOT NULL,
    [isLikesVegetables] bit  NOT NULL,
    [isPickupPoint] bit  NOT NULL,
    [isLogistic] nvarchar(max)  NOT NULL
);
GO
...
-- Creating foreign key on [AspNetUserId] in table 'Products'
ALTER TABLE [dbo].[Products]
ADD CONSTRAINT [FK_AspNetUserProduct]
    FOREIGN KEY ([AspNetUserId])
    REFERENCES [dbo].[AspNetUsers]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_AspNetUserProduct'
CREATE INDEX [IX_FK_AspNetUserProduct]
ON [dbo].[Products]
    ([AspNetUserId]);
GO
